...
public class FeedTypeController extends AbstractController {
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/feedType-type", method = RequestMethod.POST, produces = "application/json")
    ...
    @RequestMapping(value = "/feedType-type", method = RequestMethod.GET, produces = "application/json")
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/feedType-type/{id}", method = RequestMethod.PUT, produces = "application/json")
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/feedType-type/{id}", method = RequestMethod.GET, produces = "application/json")
